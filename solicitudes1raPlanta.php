			...
			<nav class="navbar navbar-expand-lg navbar-light bd-highlight border-bottom">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto pr-4">
						<li class="nav-item ">
							<a class="nav-link" id="words" href="solicitudes1raPlanta.php"><strong>Primera planta</strong>&nbsp;&nbsp;|</a>
						</li>
						<li class="nav-item ">
			...
			<div class="card-deck mb-3">
				<div class="card mb-4 shadow-sm">
					<div class="card-header border border-primary d-flex align-items-center">
						<img src="img/c1P1.png" width="30px" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
						<!-- script para obtener el estado del cubiculo -->
						<?php echo imprimirEstado("c1P1"); ?>
					</div>
					<div class="card-body">
							...
							<div>
								<ul class="list-unstyled mt-3 mb-4">
									<li>
										...
										<?php echo impresionUsuarioActivo("c1P1",date("Y-m-d")); ?>						 
									</li>
								</ul>
							</div>
							<div class="">
								<table>
									<tr>
										<td>
											<?php echo botonAutorizar("c1P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonLiberar("c1P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonCancelar("c1P1"); ?>
										</td>
									</tr>
								</table>
							</div>
						...
						<div>
							...
							<?php reservasEnCola("c1P1", date("Y-m-d")); ?>
						</div>
					</div>
			  	</div>
			</div>
				...
				<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<div class="d-flex justify-content-between">
							<div>
								<ul class="list-unstyled mt-3 mb-4">
									<li>
										<!-- impresión del usuario activo -->
										<?php echo impresionUsuarioActivo("c2P1",date("Y-m-d")); ?>						 
									</li>
								</ul>
							</div>
							<div class="">
								<table>
									<tr>
										<td>
											<?php echo botonAutorizar("c2P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonLiberar("c2P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonCancelar("c2P1"); ?>
										</td>
									</tr>
								</table>
							</div>
						...
						<div>
							...
							<?php reservasEnCola("c2P1", date("Y-m-d")); ?>
						</div>
					</div>
			  	</div>
			</div>
				...
				<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<div class="d-flex justify-content-between">
							<div>
								<ul class="list-unstyled mt-3 mb-4">
									<li>
										<!-- impresión del usuario activo -->
										<?php echo impresionUsuarioActivo("c3P1",date("Y-m-d")); ?>						 
									</li>
								</ul>
							</div>
							<div class="">
								<table>
									<tr>
										<td>
											<?php echo botonAutorizar("c3P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonLiberar("c3P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonCancelar("c3P1"); ?>
										</td>
									</tr>
								</table>
							</div>
						...
						<div>
							...
							<?php reservasEnCola("c3P1", date("Y-m-d")); ?>
						</div>
					</div>
			  	</div>
			</div>
				...
				<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<div class="d-flex justify-content-between">
							<div>
								<ul class="list-unstyled mt-3 mb-4">
									<li>
										<!-- impresión del usuario activo -->
										<?php echo impresionUsuarioActivo("c4P1",date("Y-m-d")); ?>						 
									</li>
								</ul>
							</div>
							<div class="">
								<table>
									<tr>
										<td>
											<?php echo botonAutorizar("c4P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonLiberar("c4P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonCancelar("c4P1"); ?>
										</td>
									</tr>
								</table>
							</div>
						...
						<div>
							...
							<?php reservasEnCola("c4P1", date("Y-m-d")); ?>
						</div>
					</div>
			  	</div>
			</div>
				...
				<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<div class="d-flex justify-content-between">
							<div>
								<ul class="list-unstyled mt-3 mb-4">
									<li>
										<!-- impresión del usuario activo -->
										<?php echo impresionUsuarioActivo("c5P1",date("Y-m-d")); ?>						 
									</li>
								</ul>
							</div>
							<div class="">
								<table>
									<tr>
										<td>
											<?php echo botonAutorizar("c5P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonLiberar("c5P1"); ?>
										</td>
										<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<td>
											<?php echo botonCancelar("c5P1"); ?>
										</td>
									</tr>
								</table>
							</div>
						...
						<div>
							...
							<?php reservasEnCola("c5P1", date("Y-m-d")); ?>
						</div>
					</div>
			  	</div>
			</div>
...
<!--Modals autorizar-->
<div class="modal fade" id="autorizarc1P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalAutorizar("c1P1"); ?>
</div>
<div class="modal fade" id="autorizarc2P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalAutorizar("c2P1"); ?>
</div>
<div class="modal fade" id="autorizarc3P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalAutorizar("c3P1"); ?>
</div>
<div class="modal fade" id="autorizarc4P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalAutorizar("c4P1"); ?>
</div>
<div class="modal fade" id="autorizarc5P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalAutorizar("c5P1"); ?>
</div>
<!--Termina Modal autorizar -->

<!--Modals liberar-->
<div class="modal fade" id="liberarc1P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalLiberar("c1P1"); ?>
</div>
<div class="modal fade" id="liberarc2P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalLiberar("c2P1"); ?>
</div>
<div class="modal fade" id="liberarc3P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalLiberar("c3P1"); ?>
</div>
<div class="modal fade" id="liberarc4P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalLiberar("c4P1"); ?>
</div>
<div class="modal fade" id="liberarc5P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalLiberar("c5P1"); ?>
</div>
<!--Termina Modal liberar -->

<!--Modals eliminar-->
<div class="modal fade" id="eliminarc1P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalEliminar("c1P1"); ?>
</div>
<div class="modal fade" id="eliminarc2P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalEliminar("c2P1"); ?>
</div>
<div class="modal fade" id="eliminarc3P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalEliminar("c3P1"); ?>
</div>
<div class="modal fade" id="eliminarc4P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalEliminar("c4P1"); ?>
</div>
<div class="modal fade" id="eliminarc5P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalEliminar("c5P1"); ?>
</div>
