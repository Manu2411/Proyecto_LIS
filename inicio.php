			...
			<nav class="navbar navbar-expand-lg navbar-light bd-highlight border-bottom">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
				  <ul class="navbar-nav ml-auto pr-4">
					<li class="nav-item ">
					  <a class="nav-link" id="words" href="inicio.php"><strong>Primera planta</strong>&nbsp;&nbsp;|</a>
					</li>
					<li class="nav-item ">
			  	...
			  	<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<ul class="list-unstyled mt-3 mb-4">
							...
							<?php echo obtenerReservas(1, "c1P1"); ?>
						</ul>
						<?php echo botonSolicitar("c1P1"); ?>
						<?php echo botonReservar("c1P1"); ?>
					</div>
			  	</div>
			<!-- termina cubiculo 1 -->
			...
			<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<ul class="list-unstyled mt-3 mb-4">
							...
							<!-- obtención e impresión de las reservas pasando la categoria de registro y el codigo del cubiculo-->
							<?php obtenerReservas(1, "c2P1"); ?>
						</ul>
						<?php echo botonSolicitar("c2P1"); ?>
						<?php echo botonReservar("c2P1"); ?>
					</div>
			  	</div>
			<!-- termina cubiculo 2 -->
			...
			<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<ul class="list-unstyled mt-3 mb-4">
							...
							<!-- obtención e impresión de las reservas pasando la categoria de registro y el codigo del cubiculo-->
							<?php echo obtenerReservas(1, "c3P1"); ?>
						</ul>
						<?php echo botonSolicitar("c3P1"); ?>
						<?php echo botonReservar("c3P1"); ?>
					</div>
			  	</div>
			<!-- termina cubiculo 3 -->
		</div>
			...
			<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<ul class="list-unstyled mt-3 mb-4">
							...
							<!-- obtención e impresión de las reservas pasando la categoria de registro y el codigo del cubiculo-->
							<?php echo obtenerReservas(1, "c4P1"); ?>
						</ul>
						<?php echo botonSolicitar("c4P1"); ?>
						<?php echo botonReservar("c4P1"); ?>
					</div>
			  	</div>
			<!-- termina cubiculo 4 -->
			...
			<div class="card mb-4 shadow-sm">
					...
					<div class="card-body">
						<ul class="list-unstyled mt-3 mb-4">
							...
							<!-- obtención e impresión de las reservas pasando la categoria de registro y el codigo del cubiculo-->
							<?php echo obtenerReservas(1, "c5P1"); ?>
						</ul>
						<?php echo botonSolicitar("c5P1"); ?>
						<?php echo botonReservar("c5P1"); ?>
					</div>
			  	</div>
			<!-- termina cubiculo 5 -->
...
<!--Modals solicitar-->
<div class="modal fade" id="solicitarc1P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalSolicitar("c1P1"); ?>
</div>
<div class="modal fade" id="solicitarc2P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalSolicitar("c2P1"); ?>
</div>
<div class="modal fade" id="solicitarc3P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalSolicitar("c3P1"); ?>
</div>
<div class="modal fade" id="solicitarc4P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalSolicitar("c4P1"); ?>
</div>
<div class="modal fade" id="solicitarc5P1" tabindex="-1" role="dialog" aria-labelledby="solicitarLabel" aria-hidden="true">
	<?php echo impresionModalSolicitar("c5P1"); ?>
</div>
<!--Termina Modal solicitar -->

<!--Modals reservar-->
<div class="modal fade" id="reservarc1P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalReservar("c1P1"); ?>
</div>
<div class="modal fade" id="reservarc2P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalReservar("c2P1"); ?>
</div>
<div class="modal fade" id="reservarc3P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalReservar("c3P1"); ?>
</div>
<div class="modal fade" id="reservarc4P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalReservar("c4P1"); ?>
</div>
<div class="modal fade" id="reservarc5P1" tabindex="-1" role="dialog" aria-labelledby="reservarLabel" aria-hidden="true">
	<?php echo impresionModalReservar("c5P1"); ?>
</div>
...
<!-- modal claveIncorrecta -->
<div class="modal fade" id="claveIncorrecta" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
			<div class="modal-header">
